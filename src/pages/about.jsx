...
import { AiFillEnvironment as Ubicacion, AiFillMail as Correo, AiFillInstagram as Insta, AiFillYoutube as Youtube, AiOutlineTwitter as Twitter, AiFillFacebook as Facebook, AiFillMobile as Mobile, AiOutlineUser as Redes } from 'react-icons/ai';
import { BsFillTelephoneOutboundFill as Phone, BsFillTelephoneFill as LocalPhone} from "react-icons/bs";
      ...
      <div className="container-fluid d-flex justify-content-center align-items-center contactanosContainer pt-5 mt-5 flex-wrap">
        ...
        <div className="col-12 col-md-12 col-lg-6 col-xl-6 col-xxl-6  d-flex justify-content-center align-items-center flex-wrap containerTarjeta">
          <div className="tarjetaContac m-2">
            <Ubicacion size={'2em'} color={'#FF7B00'} className="iconContactanos"></Ubicacion>
            <h5>Ubicación</h5>
            <p>Av Andres Bello edif. Centro Andres Bello Torre Este piso PH, Caracas, Venezuela.</p>
          </div>
          <div className="tarjetaContac m-2">
            <Correo size={'2em'} color={'#FF7B00'} className="iconContactanos"></Correo>
            <h5>Correo</h5>
            <p id="correoText">admon.saint@gmail.com</p>
          </div>
          <div className="tarjetaContac m-2">
            <Redes size={'2.3em'} color={'#FF7B00'} className="iconContactanos"></Redes>
            <h5>Redes</h5>
            <ul className="listaRedes">
              <li><Insta size={'1.2em'} color={'#FF7B00'} className="iconContactanos"></Insta><a className="linkRedes" href="https://www.instagram.com/consultoresrjd/?hl=es-la">@consultoresrjd</a></li>

              <li><Youtube size={'1.2em'} color={'#FF7B00'} className="iconContactanos"></Youtube><a className="linkRedes" href="https://www.youtube.com/channel/UCF-ntNi3akbt00DbnAR2w6w">YouTube</a></li>
